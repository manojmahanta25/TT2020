        ...
        <div class="portfoliomain">
            <div class="col-md-7 col-sm-12 col-xs-12" style="background:rgba(255,253,253,0.8);padding: 12px;">
                <div class="speaker-content">
                    <span><h3>OPEN MIC</h3></span>
                    <p>Express yourself in your own words and win hearts with your uniqueness. A little get together to share one feeling and showcase your talent with words, be it rapping, stand-up comedy, slam poetry or story telling.</p>
                    <p>Unleash the poet, the rapper, the comedian or story teller within you. Share stories of travel, love, adventure, friendships forged on the road, and people in your own unique style.</p>
                    <br/><br/><br/>
                </div>
            </div>
                                    ...
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <div class="speaker-statement">
                                            ...
                                            <ul style="text-align: justify; list-style:none;">
                                                <li>Venue: Bhukkad</li>
                                                <li>Starting Time: 01:00 PM - 02:30 PM</li>
                                        ...
                                        <div class="speaker-statement" style="text-align: left;margin-left: 20px;">
                                            <a class="ristrabtn" href="{{route('tt.registersingle','openmic')}}" alt="">REGISTER</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- schedule-table -->
