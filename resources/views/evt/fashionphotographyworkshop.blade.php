<section id="portfolio" class="portfolio" style="background: url(../images/events/evnt_bck.jpg)center center no-repeat;background-size:cover; ">
    <div class="container">
        ...
        <div class="heading" style="padding-top:50px;">
            <h2>Fashion Photography Workshop</h2>
        </div>
        <!--end heading-->
                                    ...
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <div class="speaker-statement">
                                            ...
                                            <ul style="text-align: justify; list-style:none;">
                                                <li>Venue: SET Classroom</li>
                                                <li>Starting Time: 11:00 AM - 01:00 PM [Break: 01:00 PM - 02:00 PM] 02:00 PM - 03:00 PM</li>
                                                <li>Date: 31<sup>st</sup> Jan. 2020, 1<sup>st</sup> Feb. 2020, 2<sup>nd</sup> Feb. 2020</li>
                                            </ul>
                                        </div><br/>
                                        <div class="speaker-statement">
                                        ...
                                        <div class="speaker-statement" style="text-align: left;margin-left: 20px;">
                                            <a class="ristrabtn" href="{{route('tt.registersingle','fashionphotography')}}" alt="">REGISTER</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- schedule-table -->
