                                ...
                                <div class="schedule-table table-responsive">
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <ol style="text-align: justify; list-style-type: decimal; margin-left: 50px; margin-top: 10px;">
                                            <li>Standard rules a 5 on 5 Basketball Game will be followed.</li>
                                            <li>10 Minutes will be alloted per quarter.</li>
                                            <li>The Officials decision is the last decision</li>
                                            <li>Matches shall be played under flood lights also.</li>
