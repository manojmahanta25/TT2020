                                ...
                                <div class="schedule-table table-responsive">
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <ol style="text-align: justify; list-style-type: decimal; margin-left: 50px; margin-top: 10px;">
                                            <li>The performance must be in Hindi, English and Assamese</li>
                                            <li>The minimum age limit for this competition is 14 years.</li>
                                            <li>Usage of fire/water/smoke in any form is not allowed.</li>
                                            <li>Time limit is 1 minute and not less than a minute.</li>
                                            <li>Participants must bring their own laptops for sound effects. For any music track or video file, the participant has to submit it to the event coordinators well in advance.</li>
                                            <li>Issues like crossing time limits, using abusive language, or vulgarity will lead to negative marking.</li>
                                            <li>Judges&rsquo; decision is final and abiding.</li>
                                        </ol><br/>
                                        ...
                                        <div class="speaker-statement" style="text-align: left;margin-left: 20px;">
                                            <a class="ristrabtn" href="{{route('tt.registersingle','justaminute')}}" alt="">REGISTER</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- schedule-table -->
