                                    ...
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <div class="speaker-statement">
                                            ...
                                            <ul style="text-align: justify; list-style:none;">
                                                ...
                                                <li>Starting Time: 11:00 am - 3:00 pm </li>
                                                <li>Break Time: 01:00 pm - 02:00 pm </li>
                                                <li>Date: 31<sup>st</sup> Jan., 1<sup>st</sup> Feb. and 2<sup>nd</sup> Feb. 2020</li>
                                            </ul>
                                        </div><br/>
                                        ...
                                        <div class="speaker-statement" style="text-align: left;margin-left: 20px;">
                                            <a class="ristrabtn" href="{{route('tt.registersingle','singingworkshop')}}" alt="">REGISTER</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- schedule-table -->
