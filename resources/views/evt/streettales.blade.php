                                ...
                                <div class="schedule-table table-responsive">
                                    <div class="speaker-statement" aria-hidden="true">
                                        ...
                                        <ol style="text-align: justify; list-style-type: decimal; margin-left: 50px; margin-top: 10px;">
                                            <li>The participants will be provided with items mentioned in a basket (which will be provided by KU) and they have the liberty to roam around the campus and sell their products.</li>
                                            <li>The person who sells them at a maximum profit will be declared as the winner, the participants have to be very vigorous when it comes to selling and marketing household products to strangers.</li>
                                            <li>This competition will test a participant’s will to survive the market demand, and make the buyers understand the need of that product.</li>
                                        </ol><br/>
                                        ...
                                        <div class="speaker-statement" style="text-align: left;margin-left: 20px;">
                                            <a class="ristrabtn" href="{{route('tt.registersingle','streettales')}}" alt="">REGISTER</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- schedule-table -->
